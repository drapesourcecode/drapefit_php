<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a class="active-color" href="<?= h(HTTP_ROOT) ?>appadmins/create_employee">   <i class="fa  fa-user-plus"></i> Create New Employee </a></li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <?php $account_type = ['21' => 'Merchandise Manager', '22' => 'Merchandise Assistant', '23' => 'Buyer Director', '24' => 'Senior Buyer', '25' => 'Buyer']; ?>
                                ...
                                <?php foreach ($adminLists as $admin): ?>
                                    <tr id="<?php echo $admin->id; ?>" class="message_box">
                                        ...
                                        <td style="text-align: center;">
                                            <?= $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-fw fa-gg')), ['action' => 'setPassword', $admin->id], ['escape' => false, "data-placement" => "top", "data-hint" => "Set New Password", 'class' => 'btn btn-info hint--top  hint', 'style' => 'padding: 0 7px!important;']); ?>
                                            <?= $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-edit')), ['action' => 'createEmployee', $admin->id], ['escape' => false, "data-placement" => "top", "data-hint" => "Edit", 'class' => 'btn btn-info hint--top  hint', 'style' => 'padding: 0 7px!important;']); ?>
