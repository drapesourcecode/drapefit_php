<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a  href="<?= h(HTTP_ROOT) ?>appadmins/view_employee"> <i class="fa fa-list"></i>Admin List</a></li>
        </ol>
    </section>
    <!-- Main content -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?= $this->Form->input('about', ['type' => 'textarea', 'class' => "form-control", 'label' => false, 'value' => @$editAdmin->about, 'kl_virtual_keyboard_secure_input' => "on"]); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exampleInputName">Account type <span style="color: red;">*</span></label>
                                <?php $account_type = ['21' => 'Merchandise Manager', '22' => 'Merchandise Assistant', '23' => 'Buyer Director', '24' => 'Senior Buyer', '25' => 'Buyer']; ?>
                                <select class = "form-control" name="type" required data-error ='Select Employee type'>
                                    <option value="" selected disabled>Select user type</option>
                                    <?php foreach ($account_type as $ac_ky => $ac_li) { ?>
                                        <option value="<?= $ac_ky; ?>" <?= (!empty($editAdmin->type) && ($editAdmin->type == $ac_ky )) ? 'selected' : ''; ?>><?= $ac_li; ?></option>
                                    <?php } ?>
                                </select>
                                <div class="help-block with-errors"></div>
                            </div>
