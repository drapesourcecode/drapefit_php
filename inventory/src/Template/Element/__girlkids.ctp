<div class="tab-content boy-kid-select" style="width: 100%;float: left;">
    ...
    <?php } ?>    
                                    ...
                                    <div class="col-md-6 "  style="<?= (in_array($product_ctg_nme,["D12"])) ? 'display:block;' : 'display:none;'; ?>" >
                                ...
                                <div class="row">
                                    <div class="col-md-6"  style="<?= (in_array($product_ctg_nme,["D1", "D2", "D3", "D7", "D8", "D9", "D11"])) ? 'display:block;' : 'display:none;'; ?>" >
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6"  style="<?= (in_array($product_ctg_nme,["D4", "D5", "D6", "D11"])) ? 'display:block;' : 'display:none;'; ?>" >
                                        <div class="form-group">
