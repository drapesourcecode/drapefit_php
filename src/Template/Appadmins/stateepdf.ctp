                ...
                <tbody>
                    ...
                    foreach ($data as $user) {
                        ...
                        <tr>
                            ...
                            <td class="service"><?php echo $user->state; ?></td>
                            <td class="service"><?php echo $user->city; ?></td>
                            <td class="service"><?php echo $user->country; ?></td>
                            <td class="service"><?php echo $user->zipcode; ?></td>
