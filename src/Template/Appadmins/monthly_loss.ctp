                                ...
                                <div class="row" style="float: left;width: 100%;">
                                    <div class="row" style="float: left;width: 100%;">
                                        <div class="col-md-6" style="float: left;"> 
                                            <?php
                                            echo $this->Html->link($this->Html->tag('i', ' Download pdf', array('class' => 'fa fa-download')), ['action' => 'monthlyLossPdf', '?month=' . $month . '&year=' . $year], ['escape' => false, "data-placement" => "top", "data-hint" => "Download pdf", 'class' => 'btn btn-info  hint--top  hint', 'style' => 'padding: 0 12px!important;']);

                                            echo $this->Html->link($this->Html->tag('i', ' Download excel', array('class' => 'fa fa-download')), ['action' => 'monthlyLossExcel', '?month=' . $month . '&year=' . $year], ['escape' => false, "data-placement" => "top", "data-hint" => "Download pdf", 'class' => 'btn btn-info  hint--top  hint', 'style' => 'padding: 0 12px!important;']);
                                            ?>
                                        </div>
                                        <div class="col-md-2" > 
