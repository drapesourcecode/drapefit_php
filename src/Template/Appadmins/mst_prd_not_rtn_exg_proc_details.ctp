...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <?= 'Products not return exchange Details Report' ?>
        </h1>
        <ol class="breadcrumb">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($product_list as $key => $prodDetls):
                                                if ($prodDetls->product_exchange_date == null) {
                                                    ?>
                                                    <tr>                                        
                                                        <td><?php echo $key + 1; ?></td>
                                                        <td><?php echo $prodDetls->product_name_one; ?></td>
                                                        <td><?php echo $prodDetls->barcode_value; ?></td>
                                                        ...
                                                        <td><?php
                                                            $statuss = '';
                                                            if ($prodDetls->keep_status == 3) {
                                                                $statuss = 'Keep';
                                                            }
                                                            if ($prodDetls->keep_status == 2) {
                                                                $statuss = 'Exchange';
                                                            }
                                                            if ($prodDetls->keep_status == 1) {
                                                                $statuss = 'Return';
                                                            }
                                                            echo $statuss;
                                                            ?></td>
