                            ...
                            <div  class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <select  name="search_for" required>
                                        ...
                                        <option value="date" <?= (!empty($_GET['search_for']) && ($_GET['search_for'] == "date")) ? "selected" : ""; ?> >Date</option>
                                    </select>
                        ...
                        <table id="exampleXX" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php foreach ($AllUserList as $aduserlist): ?>
                                    <tr>
                                        <td><?php echo $aduserlist->usr->name; ?></td>
                                        <td><?php
                                            if ($aduserlist->usr_d->gender == 1) {
                                                echo "Men";
                                            } else if ($aduserlist->usr_d->gender == 2) {
                                                echo "Women";
                                            } else {
                                                echo "Kids";
                                            }
                                        ...
                                        <td><?php
                                            $namex = "";
                                            if (!empty($aduserlist->kid_d)) {
                                                $namex = $aduserlist->kid_d->kids_first_name;
                                            } else {
                                                if ($aduserlist->kid_d->kid_count == '1') {
                                                    $namex = 'First Child';
                                                }
                                                if ($aduserlist->kid_d->kid_count == '2') {
                                                    $namex = 'Second Child';
                                                }
                                                if ($aduserlist->kid_d->kid_count == '3') {
                                                    $namex = 'Third Child';
                                                }
                                                if ($aduserlist->kid_d->kid_count == '4') {
                                                    $namex = 'Four Child';
                                                }
                                            }
                                            echo $namex;
                                            ?></td>
                                        <td><?php echo $aduserlist->usr->email; ?></td>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <?php if ($aduserlist->usr_d->gender == 3) { ?>
                                                <a href="<?php echo HTTP_ROOT . 'appadmins/customerKidProfile/' . $aduserlist->kid_id; ?>" target="_blank" class="btn btn-info hint--top  hint view-i">Kids Profile</a>
                                            <?php } else { ?>
                                                <a href="<?php echo HTTP_ROOT . 'appadmins/review-users/' . $aduserlist->user_id; ?>" target="_blank" class="btn btn-info hint--top  hint view-i">View Profile</a>
                                            <?php } ?>
                                        </td>
                                    </tr>
