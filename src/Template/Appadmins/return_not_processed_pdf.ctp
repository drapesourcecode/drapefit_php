...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Customer who has Checked out already but return not processed</title>
        <style>
            @font-face {
                font-family: Junge;
...
//                                        echo "</pre>";
        ...
        <footer>
            Customer who has Checked out already but return not processed Report was created on a computer and is valid without the signature and seal.
        </footer>
    </body>
</html>