                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-md-6">
                                        <?php if (@$productData->product_image) { ?>
                                            ...
                                            <br>
                                            <div class="col-md-6">
                                                <img src="<?php echo HTTP_ROOT ;?><?= strstr(@$productData->product_image, PRODUCT_IMAGES)?@$productData->product_image:PRODUCT_IMAGES.@$productData->product_image; ?>" alt="<?php echo $data['product_name_one']; ?>" style="width: 300px; height: 150px"/>
                                            </div>
                                    ...
                                    <?php } ?>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <br>
                                            <?php 
                                            $in_pro_key = $productData->inv_product_id;
                                            if (empty($in_pro_key)) { ?>
                                                <img width="100" height="20"  src="<?php echo HTTP_ROOT . BARCODE . $productData->barcode_image; ?>"/> 
                                            <?php } else { ?>
                                                <img width="100" height="20"  src="<?php echo HTTP_ROOT . 'inventory/files/barcode/' . $productData->barcode_image; ?>"/> 
                                            <?php } ?>
                                            <br> <?php //echo $list->barcode_value; ?>
                                            <?= $productData->is_verified == 1 ? "<span><i style='color:green'class='fa fa-check'></i></span>" : ""; ?>
