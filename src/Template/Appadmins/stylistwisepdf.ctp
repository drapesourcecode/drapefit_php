...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title> Reports for style list</title>
        <style>
            @font-face {
                font-family: Junge;
                    ...
                    foreach ($stylist as $user) {
                        ...
                        <tr>
                            <?php if ($value == 1 || $value == '') { ?>
                                <td class="service"><?php echo $this->Custom->customerName($user->emp_id); ?></td>
                            <?php } else { ?>
                                <td class="service"><?php echo $this->Custom->customerName($user->employee_id); ?></td>
                            <?php } ?>

                            <td class="service"><?php echo $this->Custom->customerEmail($user->user_id); ?></td>
                            <td class="service"><?php echo $this->Custom->customerName($user->user_id); ?></td>
                            <td class="service"><?php echo $this->Custom->kidName(@$user->kid_id); ?></td>
                            <td class="service"><?php echo $user->created_dt; ?></td>
                            <td class="service"><?php echo $this->Custom->workStatus($user->work_status); ?></td>
                        </tr>
