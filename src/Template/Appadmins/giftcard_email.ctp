                            ...
                            <tbody>
                                <?php foreach (@$giftdetails as $list): ?>
                                    <tr>
                                        ...
                                        <td style="text-align:  left;"> <?php echo $list->to_email; ?></td>
                                        ...
                                        <td style="text-align:  left;"> <?php echo date('d M,y', strtotime($list->delivery_date)); ?></td>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <?php } ?>
                                           <?= $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-eye')), ['action' => 'viewGiftcardEmail/' . $list->id], ['escape' => false, "data-placement" => "top", "data-hint" => "Gift code send to user", 'class' => 'btn btn-info  hint--top  hint', 'style' => 'padding: 0 7px!important;']); ?>
