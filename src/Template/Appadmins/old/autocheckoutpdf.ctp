            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th class="service">Profile Type</th>
                        <th class="service">Stylist name</th>
                        <th class="service">Finalize Date</th> 
                        <th class="service">Product Count</th> 
                        <th class="service">Product price</th> 
                        <th class="service">Auto check Out date</th>
                    </tr>
                ...
                <tbody>
                    ...
                    foreach ($notpaid_users as $user) {
                        ?>
                        <tr>
                            <td  class="service"><?php echo date('y-m-d', strtotime($user->created_dt)); ?></td>
                            <td  class="service"><?php echo $this->Custom->UserName($user->user_id); ?></td>
                            <td  class="service"><?php echo $this->Custom->kidName($user->kid_id) ?></td>
                            ...
                            <td class="service"><?php
                                ...
                                ?></td>
                            <td class="service"><?php echo $this->Custom->emaplyeName(@$user->emp_id); ?></td>
                            <td class="service"><?php echo date('y-m-d', strtotime(@$user->finalize_date)); ?></td>
                            <td class="service"><?php echo $this->Custom->productCountPrice(@$user->parent_id); ?></td>
                            <td class="service"><?php echo @$user->price; ?></td>
                            <td class="service"><?php echo @$user->auto_check_out_date; ?></td>
