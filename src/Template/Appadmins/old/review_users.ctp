...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
                ...
                <div class="box box-primary user-detail-top">
                    <div class="box-body box-profile">
                      <!--<img class="profile-user-img img-responsive img-circle" src="../../dist/img/user4-128x128.jpg" alt="User profile picture">-->
                        ...
                        <h3 class="profile-username text-center"><?php echo $userdetails->user_detail->first_name . '-' . $userdetails->user_detail->last_name; ?></h3>
                        <p class="text-muted text-center"><?php
                            if ($userdetails->user_detail->gender == 1) {
                                echo "MEN";
                            } elseif ($userdetails->user_detail->gender == 2) {
                                echo 'WOMEN';
                            }
                            ?></p>
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item"><b>Email:</b> <a class="pull-right"><?php echo $userdetails->email; ?></a></li>
            ...
            <?php if ($userdetails->user_detail->gender == 1) { ?>
                <div class="col-md-12"> 
            ...
            <?php } else if ($userdetails->user_detail->gender == 2) { ?>
                <div class="col-md-12">
                    <div class="nav-tabs-custom">
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="post">
                                    <div class="post-left-box">     
                                        ...
                                        <div class="timeline-footer">
                                            <a class="btn btn-primary btn-xs blue"><?php if (@$Womeninfo->birthday != '') {
    ...
    <?php if (@$Womeninfo->pregnant == 1) { ?>
                                    ...
                                    <div class="post">
                                        ...
                                        <div class="timeline-footer">
                                            <a class="btn btn-primary btn-xs blue" style="width: 100px;"><?php if ($SizeChart->is_prefer_maternity == 0) {
            echo '';
        } else {
            echo $SizeChart->is_prefer_maternity;
                                    ...
                                    <div class="post">
                                        ...
                                        <div class="timeline-footer">
                                            <a class="btn btn-primary btn-xs blue" style="width: 100px;"><?php if ($SizeChart->loose_fitted == 0) {
            echo '';
        } else {
