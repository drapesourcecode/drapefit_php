                                ...
                                *, *:before, *:after {
                                ...
                                <div style="width:100%;float:left;">
                                    <div class="product-details">
                                        ...
                                        <ul class="list_unstyled_ul">
                                            <li><a href="" title="">Name : <span class="pull-right"><?php echo $giftdetails->recipinet_name; ?></span></a></li>
                                            <li><a href="" title="">Address : <span class="pull-right"><?php echo $giftdetails->recipinet_address . ', ' . $giftdetails->address_line2; ?></span></a></li>
                                            <li><a href="" title=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="pull-right"><?= $giftdetails->city . ', ' . $giftdetails->state; ?></span></a></li>
                                            <li><a href="" title=""> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="pull-right"><?= $giftdetails->zipcode; ?></span></a></li>
                                ...
                                <div style="float: left !important;width: 100%;">
                                    <div class="product-image2">
                                        <ul class="list_unstyled_ul">
                                            <li><a href="" title=""><span class="pull-right"><strong> <?php echo nl2br($giftdetails->msg); ?></strong></span></a></li>
                                    ...
                                    <div style="float: right !important;width: 49%;padding-right: 25px">
                                        ...
                                        <ul class="list_unstyled_ul">
                                            ...
                                            <li><a href="" title="">Email : <span class="pull-right"><?php echo $giftdetails->from_email; ?></span></a></li>
