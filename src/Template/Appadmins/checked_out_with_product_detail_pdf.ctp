...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Customer checked out with product details</title>
        <style>
            @font-face {
                font-family: Junge;
...
//                                        echo "</pre>";
                    foreach ($new_data as $key => $n_dt) {
                        ...
                        <tr>
                            ...
                            <td><b><?=  $total_checkout_price; ?></b></td>
                        </tr>
        ...
        <footer>
            Customer checked out with product details Report was created on a computer and is valid without the signature and seal.
        </footer>
    </body>
</html>