...
<div class="row">
<div class="col-sm-12">
<div class="it-work-top it-work-top4">
...
<p>At Drape Fit, we are always looking for passionate and talented people to join our team. If you're enthusiastic about joining an innovative, growing start-up with a mission of making the styling experience accessible to all, check out our job listings below.</p>
</div>
</div>
</div>
</div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="assistant-text" >
                        ...
                        <a  href="#applyform" class="sign-up-btn">Apply Now</a>
                    </div>
                        </div>
                    ...
                    <div class="apply-Job-form-box" id="applyform">
                        <?php echo $this->Form->create('', ['type' => 'file', 'data-toggle' => "validator", 'novalidate' => "true", 'id' => 'careerform']); ?>
                            <div class="main_fields">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-lg-6 col-md-12">
                                        <div class="field">
                                            <div class="field-docum">
                                            <label>Resume/CV <span class="asterisk">*</span></label>
                                            <ul>
                                                <!--<li><a id="OpenDocUpload">Attach</a></li>-->
                                                <input type="file" onchange="ValidateSingleInput(this);"  id="attachfile" name="attachfile[]" style="display:block"/>
                                                <span style="color:red;">(1 MB .word, .pdf)</span>
                                            ...
                                            <ul>
                                                ...
                                                <input type="file" onchange="ValidateSingleInput(this);" id="attachfiletwo" name="attachfile[]" style="display:block"/>
                                                <span style="color:red;">(1 MB .word, .pdf)</span>
                                                <!--<li><a href="#">Dropbox</a></li>
                                                <li><a href="#">Google Drive</a></li>-->
                            ...
                            <div class="submit_buttons">
                                <input style="margin-top:25px;" type="submit" value="Submit Application"  class="button">
                            </div>
...
<script>
    var _validFileExtensions = [".doc", ".docx", ".txt", ".pdf", ".PDF"];    
    ...
    $(function(){
        ...
        $("#careerform").validate({
            ...
            messages:{
                ...
                phone:{
                    required:"Please enter your pnone",
                },
                location:{
