        ...
        <div class="inner-banner-text">
            <div class="container">
                <div class="row">
                    ...
                    <h1><a href="<?= HTTP_ROOT; ?>kids"><?php echo $refname; ?> Thinks You'd Like Drape Fit Kids</a></h1>
                ...
                <div class="col-sm-12">
                    <div class="it-work-top">
                        <div class="section-head" data-aos="fade-down">
                            <h2><span>Thinks You'd Like </span> Drape Fit Kids</h2>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-3 col-md-3">
                <div class="process-box">
                    <div class="prosses-img">
                        <img src="https://www.drapefittest.com/images/Kids1.jpg">
                    </div>
            ...
            <div class="col-sm-12 col-lg-3 col-md-3">
                <div class="process-box">
                    <div class="prosses-img">
                        <img src="https://www.drapefittest.com/images/Kids3.jpg">
                    </div>
        ...
        <div class="row">
            ...
            <?php echo $this->Form->create('', ['data-toggle' => "validator", 'novalidate' => "true", 'id' => 'kidsuserformsignup', 'class' => "men-sign-up-section", 'url' => ['action' => 'userregistration']]); ?>
                    ...
                    <div class="sign-up-form">
                        ...
                        <input type="hidden"  name="gender" value="kids" required>
